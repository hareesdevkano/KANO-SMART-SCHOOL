-- Drop and recreate the register_school function with correct column name and constraint handling
...
BEGIN
  ...
  -- 3. Assign school_admin role (handle unique constraint on user_id, role, school_id)
